...
public class WeaponCallbackElementium implements IWeaponCallback 
{
			...
			ITooltipFlag flag) 
	{
		...
		tooltip.add(TextFormatting.LIGHT_PURPLE + StringHelper.translateString("pixielated", "tooltip", Reference.ModID));
		if(GuiScreen.isShiftKeyDown())
		{
			tooltip.add(TextFormatting.ITALIC + " " + StringHelper.translateFormattedString("pixielated.desc", "tooltip", Reference.ModID, WeaponPropertySWA.Pixielated5P.getMagnitude()));
		}
	}
